...
const AutoContactModal = () => {
  ...
  return (
    <>
      <button type="button" className="fixed inset-0 z-40 bg-[#121826]/62 backdrop-blur-sm" aria-label="Close" onClick={() => setIsOpen(false)} />

      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="w-full max-w-lg overflow-hidden border border-white/18 bg-white shadow-2xl" style={{ borderRadius: "0.5rem" }}>
          ...
          <div className="bg-[#121826] p-6 text-white">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-3 text-2xl text-white">Need product pricing?</h2>
                <p className="mt-2 text-sm leading-6 text-white/68">Share your product, quantity and destination.</p>
              </div>
              <button type="button" onClick={() => setIsOpen(false)} className="flex h-10 w-10 shrink-0 items-center justify-center border border-white/14 text-white hover:bg-white/10" style={{ borderRadius: "0.5rem" }} aria-label="Close">
                <X size={20} />
              </button>
            </div>
          </div>
...
// import { useEffect, useState } from "react";
// import { Mail, MessageCircle, MessageSquare, Phone, Send, User, X } from "lucide-react";
// import { Input } from "@/components/ui/input";
// import { Textarea } from "@/components/ui/textarea";
// import { useToast } from "@/hooks/use-toast";
...
//     if (!apiUrl) {
//       toast({
//         title: "Inquiry form is not connected yet",
...
//       toast({ title: "Inquiry received", description: "Our team will contact you soon." });
...
//       <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
//         <div className="overflow-hidden border border-white/18 bg-white shadow-2xl" style={{ borderRadius: "0.5rem" }}>
//           <div className="bg-[#121826] p-6 text-white">
//             <div className="flex items-start justify-between gap-4">
//               <div>
//                 <span className="inline-flex items-center gap-2 text-xs font-bold uppercase text-[#f59e0b]">
...
//                   Share your product, quantity and destination. We will guide the next step.
//                 </p>
//               </div>
//               <button
//                 type="button"
//                 onClick={() => setIsOpen(false)}
//                 className="flex h-10 w-10 shrink-0 items-center justify-center border border-white/14 text-white transition-colors hover:bg-white/10"
...
//               <div className="relative">
//                 <Phone size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#0a8f9c]" />
//                 <Input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="+91 00000 00000" className="input-premium pl-10" />
//               </div>
//             </div>
